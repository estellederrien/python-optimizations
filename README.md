# My Supply chain management , optimizations and probabilities rules notebooks dedicated for factories, business, management etc ...
<p align="center" >
...
27/12/2024 : Hi guys, I am definitly giving up the french language, ok , let's start by completing my " Fitting a maths model to a solver code" notebook, under the Optimizations directory, All of the other  files will then be methodically reviewed and rewritten. Please notice that I can do optimizations in Spanish and that I am looking to moove from my initial country, permanently, I can barely survive there, and I 'm in danger,  due to political and religious discriminations and filing. I will do just a few each day, depending on my mood,  because I ain't payed for that, and doing a book is a waste of time considering piracy. I will also dev the ODEs - Differential equations in Python, at the same time, How exciting is this. It's way simplier and clearer for me to use only one language now, less talk, more action.
